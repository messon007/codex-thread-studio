import type { OpenCodeEventModel, OpenCodeEvent, OpenCodeReduction, OpenCodeReducerHelpers } from './opencode-event-types.mjs'

export function reduceOpenCodeEvent(model: OpenCodeEventModel, event: OpenCodeEvent, selectedSessionId: string | null, helpers: OpenCodeReducerHelpers): OpenCodeReduction {
  ...
  if (type === 'message.part.updated') {
    ...
    model.messageTurns ||= {}
    if (part.messageID) model.messageTurns[String(part.messageID)] = turn.id
    model.messageItems ||= {}
  ...
  if (type === 'message.part.delta') {
    ...
    model.messageTurns ||= {}
    if (properties.messageID) model.messageTurns[String(properties.messageID)] = turn.id
    model.messageItems ||= {}
