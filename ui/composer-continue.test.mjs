...
const app = readFileSync(new URL('../ui-src/composer-actions.mts', import.meta.url), 'utf8') + readFileSync(new URL('./app.js', import.meta.url), 'utf8') + readFileSync(new URL('../ui-src/settings-application.mts', import.meta.url), 'utf8')
