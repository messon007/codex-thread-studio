...
export interface ContinuationOutput { prompt: string }
...
export function continuationDraftInput(value: unknown, limit = 32_000) {
...
export function continuationDraftTurnState(thread: UtilityThread | null | undefined): UtilityResult<ContinuationOutput> {
