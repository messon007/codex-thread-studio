...
export function normalizeMermaidPreferences(value) {
  ...
  return {
    style: allowed.style.has(source.style) ? source.style : MERMAID_PREFERENCES_DEFAULTS.style,
    density: allowed.density.has(source.density) ? source.density : MERMAID_PREFERENCES_DEFAULTS.density,
    curve: allowed.curve.has(source.curve) ? source.curve : MERMAID_PREFERENCES_DEFAULTS.curve,
    layout: allowed.layout.has(source.layout) ? source.layout : MERMAID_PREFERENCES_DEFAULTS.layout,
