...
import type { CommentProvider, EpubAnchor } from './comment-types.mjs'
import { fileDisplayName } from './document-review.mjs'

export const EPUB_COMMENT_PROVIDER = 'epub'

export function epubCommentSource(anchor: unknown = {}) {
  return {
...
export function createEpubCommentProvider(): CommentProvider {
  return {
...
export function normalizeEpubAnchor(value: unknown = {}): EpubAnchor {
