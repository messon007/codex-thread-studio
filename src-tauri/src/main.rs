...
fn gateway_router(state: GatewayState) -> Router {
    ...
    Router::new()
        ...
        .route(
            "/environment-application.mjs",
            get(environment_application_js),
        )
...
async fn session_operations_js() -> impl IntoResponse {
    javascript(include_str!("../../ui/session-operations.mjs"))
}

async fn submission_controller_js() -> impl IntoResponse {
    javascript(include_str!("../../ui/submission-controller.mjs"))
}

async fn preferences_snapshot_js() -> impl IntoResponse {
    javascript(include_str!("../../ui/preferences-snapshot.mjs"))
}

async fn environment_application_js() -> impl IntoResponse {
    javascript(include_str!("../../ui/environment-application.mjs"))
}
...
async fn selection_coordinator_js() -> impl IntoResponse {
    javascript(include_str!("../../ui/selection-coordinator.mjs"))
}
...
async fn preference_normalization_js() -> impl IntoResponse {
    javascript(include_str!("../../ui/preference-normalization.mjs"))
}
