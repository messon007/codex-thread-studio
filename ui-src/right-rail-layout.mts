...
}: { containerWidth: number; sidebarWidth?: number; dividerWidth?: number; nominalMinWidth?: number; maxRatio?: number }) {
...
export function clampRightRailWidth(value: unknown, bounds: { min: number; max: number }) {
